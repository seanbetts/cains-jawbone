...
Use stable IDs (`P01`, `P02`, …). Track aliases/tells and where they appear.
...
- `P01` — Names/aliases: Henry
  ...
  - **Notes:** MAYBE multiple different “Henrys” across the book; do not merge/split without stronger anchors (surname, role, setting continuity). For clustering, treat “Henry” as an overloaded label and require a second non-name anchor (place/quote/object/voice tell) before linking pages. Phase 6 scan: Pages/cains_jawbone_page_63.md + Pages/cains_jawbone_page_100.md treat “Henry” as physically handled (cap on/off; “getting out of hand”; “drops awa”), which may indicate an object-coded Henry (e.g., a pen) distinct from the pursuit/corpse Henry. Resolved check (2025-12-25, `N12` falsifier): “Henry” appears in incompatible roles across `N12` sub-strands (killer/suspect under pursuit vs “peerless investigator”) → treat name-only matches as non-binding.
...
- `P02` — Names/aliases: Casy Ferris
  ...
  - **Pronouns/relationships:** father (unnamed).
...
- `P04` — Names/aliases: Sir Roland Mowthalorn
  ...
  - **Pronouns/relationships:** son of Sir Weedon.
  - **Pages:** Pages/cains_jawbone_page_4.md
  - **Notes:** MAYBE local colour vs recurring character.

- `P05` — Names/aliases: Sir Weedon
  - **Tells:** mixed up Henry’s role (“Lesurques”) with “Le Cirque d’Hiver”.
  - **Pronouns/relationships:** father of Sir Roland.
  - **Pages:** Pages/cains_jawbone_page_4.md
  - **Notes:** As above.

- `P06` — Names/aliases: Annie (gin-faced Annie)
  - **Tells:** sells buttonholes behind the church; “gin-faced”.
  - **Pronouns/relationships:** none known.
  - **Pages:** Pages/cains_jawbone_page_4.md
  - **Notes:** Flower-seller motif; might recur with church/shore setting.

- `P07` — Names/aliases: “new young man” (unnamed)
  - **Tells:** “powerful grip”; parades “a couple of letters”; talks about Browning and (possibly) Cerebos.
  - **Pronouns/relationships:** none known.
  - **Pages:** Pages/cains_jawbone_page_5.md
  - **Notes:** Track if he gains a name later.

- `P08` — Names/aliases: Henry’s “intended fifth” (unnamed)
  - **Tells:** being plied with “Emperor’s Peg”.
  - **Pronouns/relationships:** Henry’s likely fiancée/courting target.
  - **Pages:** Pages/cains_jawbone_page_5.md
  - **Notes:** If later named, keep this as alias under `P08` rather than minting a new ID.

- `P09` — Names/aliases: Mrs. Gay
  - **Tells:** stayed/lay in the spare-room “in this very house” (recalled by narrator).
  - **Pronouns/relationships:** none known.
  - **Pages:** Pages/cains_jawbone_page_6.md
  - **Notes:** MAYBE recurring household name; track if she appears elsewhere.

- `P10` — Names/aliases: Charles Day
  - **Tells:** deputised for narrator’s mineralogy lectures during a fortnight absence.
  - **Pronouns/relationships:** assistant to mineralogy lecturer narrator.
...
- `P12` — Names/aliases: Boots (servant)
  ...
  - **Pronouns/relationships:** lower-order servant.
  - **Pages:** Pages/cains_jawbone_page_10.md
  - **Notes:** “Boots” may be role-title rather than personal name; keep as alias until clarified.

- `P13` — Names/aliases: Hyacinth (male, uncertain)
  - **Tells:** associated with “Hyacinth’s day” (if saint-day: Aug 16); laughs while walking round the garden.
  - **Pronouns/relationships:** “he”; connected to Boots’ misunderstanding.
  - **Pages:** Pages/cains_jawbone_page_10.md
...
- `P16` — Names/aliases: May
  ...
  - **Notes:** MAYBE linked to Page 12’s will/documents scene. CERTAIN May-as-person: Pages/cains_jawbone_page_14.md (direct address), Pages/cains_jawbone_page_80.md (“do my best for May”); LIKELY May-as-person but with pun-layer: Pages/cains_jawbone_page_98.md (“I thought of May. May be…”). Phase 6 test (2025-12-31): page-body phrase `I thought of May` appears only on Pages/cains_jawbone_page_71.md and Pages/cains_jawbone_page_98.md, but there is no second shared anchor between those pages → treat Pages/cains_jawbone_page_71.md’s “May” as a low-weight hint only (not ordering evidence). Treat Pages/cains_jawbone_page_100.md’s “as flush as May” as month/simile until a second personal-May anchor appears there. (Page 75’s “the May” reads as hawthorn/May-blossom rather than `P16` May.)
...
- `P49` — Names/aliases: Babs
  ...
  - **Notes:** Track for recurrence; MAYBE an allusive nickname (Sarah Grand’s *Babs the Impossible* (1900/1901) uses “Lorraine Kingconstance… alias ‘Babs the Impossible’” in period review snippets): https://books.google.co.uk/books?id=AAY4AQAAMAAJ&dq=%22Babs+the+Impossible%22&jscmd=SearchWithinVolume2. MAYBE the same as `P55` Babbie (diminutive overlap); do not merge without stronger anchors.
