# Objects & motifs index

Recurring items often signal continuity across pages or narrators.
...
- **Sea / coastal peril**
  ...
  - **Notes:** Possible cluster anchor for setting.
...
- **Wine + flesh remnants**
  ...
  - **Notes:** Disturbing physical continuity hook; watch for repeated meal/body imagery.

- **Conduit (1597)**
  - **Instances / variants:** market place conduit “dating from 1597”
  - **Pages:** Pages/cains_jawbone_page_13.md
  - **Notes:** Potential location anchor.

- **Lightning deaths**
  - **Instances / variants:** engaged couple struck in barley field; injury details in a letter
...
- **Accent / heredity**
  ...
  - **Notes:** Potential voice tell; may recur with “foreign touch”/class cues.

- **Wens / whiskers**
  - **Instances / variants:** “wen”; “scratched his left whisker”
  - **Pages:** Pages/cains_jawbone_page_26.md
  - **Notes:** Character physical tell; could also signal animal description.

- **Coffee blends**
  - **Instances / variants:** Peaberry Mysore; Blue Mountain mixture
  - **Pages:** Pages/cains_jawbone_page_27.md
  - **Notes:** Domestic routine marker; might link to other coffee-specific pages.
...
- **Sausages / botulism (“botulist”)**
  ...
  - **Notes:** Food/poison overlap; may be a voice tell or method clue.

- **Gardenias (Cape Jasmine)**
  - **Instances / variants:** Cape Jasmine; “gardenia… florida flore-pleno”
  - **Pages:** Pages/cains_jawbone_page_30.md
  - **Notes:** Botanical precision overlaps with other plant-savvy narrators.

- **Phalaris (“Gardener’s Garters”)**
  - **Instances / variants:** Phalaris arundinacea variegata
  - **Pages:** Pages/cains_jawbone_page_30.md
  - **Notes:** As above.
