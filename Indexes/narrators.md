...
- `N01` — Aquarius pen / “Ecky” bar voice:
  ...
  - **Pages:** Pages/cains_jawbone_page_1.md, Pages/cains_jawbone_page_17.md, Pages/cains_jawbone_page_43.md, Pages/cains_jawbone_page_100.md (LIKELY)
  - **Confidence:** `CERTAIN`
...
- `N09` — “Old man” slow-death / letter-blackmail voice:
  ...
  - **Notes:** Earlier overlap with `N05` was deprioritised; treat Pages/cains_jawbone_page_68.md as part of this voice unless school-specific anchors recur. Update (2025-12-30): a phrase-level bridge now supports unifying the “meeting/old man” and “Café Royal/account” sub-strands: Pages/cains_jawbone_page_69.md’s unique decision phrase “The answer was plain enough” ↔ Pages/cains_jawbone_page_95.md’s unique follow-through “Because I had decided what to do” (see `Order/hypotheses.md` `N09` Sequence E). Phase 6 join candidate: Pages/cains_jawbone_page_96.md may instead stitch into the `N01` Moon/Dawn table scene via Pages/cains_jawbone_page_96.md → Pages/cains_jawbone_page_17.md (meeting-wait posture + “Somerset” + marriage framing); if this firms up, treat Pages/cains_jawbone_page_96.md as a re-stitch point rather than a core `N09` page.
...
- `N11` — De’Ath (“Black Museum”) narrator:
  ...
  - **Notes:** Singleton for now; Phase 6 join check suggests Pages/cains_jawbone_page_91.md may sit immediately after Pages/cains_jawbone_page_60.md (shared “Death” + “succeed(ing)” + “steps” hinges; corpus scan: `steps` appears only on Pages/cains_jawbone_page_60.md and Pages/cains_jawbone_page_91.md; see `Order/hypotheses.md`). Next check: search for the “Black Museum” + orthographic name-instruction combo in other detective pages (esp. Pages/cains_jawbone_page_100.md) before proposing any merge.
...
- `N14` — Babbie / Rainbow Sundae / hair-and-allusion voice:
  ...
  - **Notes:** Singleton for now; next check: search for a repeat of the Rainbow/Lent “second Sundae” rule plus the hair/attribution obsession (merge only if a phrase-level anchor recurs, not just dessert titles). Phase 6 candidate: page-body `I cannot` appears only on Pages/cains_jawbone_page_63.md and Pages/cains_jawbone_page_100.md, and both pages treat “Henry” as physically handled (cap on/off ↔ “getting out of hand” / “drops awa”), suggesting a possible stitch/merge to test (keep low-weight until reinforced).
...
- `N24` — Scotland Yard collapse / Kursaal voice:
  ...
  - **Notes:** Singleton for now; next check: search for the combined Southend Kursaal + Woolworth’s + buttonhole anchors; do not merge into other police voices unless at least two of these recur together. Note: “buttonhole” also appears on Pages/cains_jawbone_page_4.md, but without the Kursaal/Woolworth’s anchors, so treat it as motif-only overlap for now. Phase 6 test (2025-12-31): Pages/cains_jawbone_page_17.md ↔ Pages/cains_jawbone_page_100.md shares three independent, corpus-unique anchors (`slips`, `her beauty`, `why should i think`) → treat this entry as a legacy sub-label for Pages/cains_jawbone_page_100.md rather than a standalone narrator (likely merges into `N01`; see `Order/hypotheses.md` v10). Phase 6 stitch candidate: page-body `I cannot` appears only on Pages/cains_jawbone_page_100.md and Pages/cains_jawbone_page_63.md (`N14`), and both pages treat Henry as physically handled (cap on/off ↔ “getting out of hand” / “drops awa”); keep as low-weight unless reinforced by a second independent anchor.
    - Update (2025-12-30): `believe me` appears only on Pages/cains_jawbone_page_100.md and Pages/cains_jawbone_page_37.md; scan found no second shared phrase-level overlap and no shared named anchor, so treat as weak until reinforced.
...
- `N33` — Medehamstede / Pasquier claret + short-story meta voice:
  ...
  - **Notes:** Singleton for now; next check: search for Medehamstede, Pasquier’s claret, Rue de la Harpe, or “Savage Conqueror” magazine references (merge only if ≥2 anchors recur together). Phase 6 scan (2025-12-31): page-body 5‑gram `but it was pleasant to` appears only on Pages/cains_jawbone_page_72.md and Pages/cains_jawbone_page_49.md, suggesting a possible stitch point out of the tail (direction unclear); treat as low-weight until reinforced.
...
- `N38` — Medical-advice payoff + “May be” pun / Quarry hills voice:
  ...
  - **Notes:** Singleton for now; Phase 6 scan (2025-12-31): page-body phrase `I thought of May` appears only here and Pages/cains_jawbone_page_71.md; treat as a low-weight May-thread continuity hint (May-as-person vs month/flower ambiguity remains). Next check: search for the Quarry hills sunset “bruise” image and the “May be. May be not.” pun; merge only if the payoff-for-identification setup repeats.
