...
- `N22` — Morbid London decoder (plague quotation voice):
  ...
  - **Notes:** Singleton for now; Phase 6 scan (2025-12-31) found a page-body 4‑gram echo `as far as I could` shared only with Pages/cains_jawbone_page_5.md (`N19`) (“…see” ↔ “…gather”); treat as low-weight until reinforced. Next check: if the plague-prose quotation (once sourced) recurs elsewhere in the same “decoding finish-line + sepulchral London” register, merge; otherwise keep separate.
