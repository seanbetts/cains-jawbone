...
- `N21` — Dazed infatuation + bar/tea imagery voice:
  ...
  - **Notes:** Page 92 quotes Browning “Saul” up to “...living and blue,” and Page 42 begins with the next line (“Just broken to twine...”), making a strong phrase-level continuity constraint (treat as a Phase 4 adjacency candidate unless the quotation is shown to be reused as an epigraph layer). Pages/cains_jawbone_page_47.md adds two high-signal `N21` tells not present in many Henry pages (Henry explicitly policing diction; drink/tea naming pivot), but it should not be used as an adjacency lock to Pages/cains_jawbone_page_42.md unless a second person/phrase anchor ties its “she” to Page 42’s “Julienne?”. Phase 6 update (2025-12-31): Pages/cains_jawbone_page_42.md shares page-body-unique words `figures` + `surmised` with Pages/cains_jawbone_page_2.md; `Order/hypotheses.md` v2.8 uses this as a cross-narrator bridge (Page 42 → Page 2) while keeping the Browning lock intact; do not merge narrator IDs without a second non-lexical continuity anchor. Note: Pages/cains_jawbone_page_49.md’s Blake excerpt (“Bring Palamabron… Elynittria”) is directly continued on Pages/cains_jawbone_page_13.md (“Rintrah… Ocalythron”) → treat that as a quote-continuation constraint and keep Pages/cains_jawbone_page_49.md assigned with Pages/cains_jawbone_page_13.md’s narrator cluster (`N20`).
