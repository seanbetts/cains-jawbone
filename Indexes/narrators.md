...
- `N01` — Aquarius pen / “Ecky” bar voice:
  ...
  - **Notes:** Hard locks: Pages/cains_jawbone_page_1.md ↔ Pages/cains_jawbone_page_43.md (Aquarius) and Pages/cains_jawbone_page_17.md ↔ Pages/cains_jawbone_page_43.md (Moon/Dawn + hand). Within-voice order: Pages/cains_jawbone_page_17.md → Pages/cains_jawbone_page_43.md (arrival beat → dessert ordering). Phase 6 join candidate: Pages/cains_jawbone_page_96.md may precede Pages/cains_jawbone_page_17.md (waiting “for the possible her” → “Ah, here she is…”, plus “Somerset” + marriage framing); keep as cross-strand until it is confirmed or falsified (see `Order/hypotheses.md`). Phase 6 merge candidate: Pages/cains_jawbone_page_100.md (currently `N24`) appears to share multiple independent `N01` anchors (dead-employer phrasing with Pages/cains_jawbone_page_1.md; unique “Why should I think…” + “her beauty” + “slips” bundle with Pages/cains_jawbone_page_17.md; Francis Thompson + Scots markers with Pages/cains_jawbone_page_43.md) → treat `N24` as a likely `N01` extension unless contradicted.
...
- `N24` — Scotland Yard collapse / Kursaal voice:
  ...
  - **Notes:** Singleton for now; next check: search for the combined Southend Kursaal + Woolworth’s + buttonhole anchors; do not merge into other police voices unless at least two of these recur together. Note: “buttonhole” also appears on Pages/cains_jawbone_page_4.md, but without the Kursaal/Woolworth’s anchors, so treat it as motif-only overlap for now. Phase 6 merge candidate: Pages/cains_jawbone_page_100.md may not be a standalone “police voice” at all; it shares multiple independent anchors with `N01` (dead-employer phrasing with Pages/cains_jawbone_page_1.md; unique “Why should I think…” + “her beauty” + “slips” bundle with Pages/cains_jawbone_page_17.md; Francis Thompson + Scots markers with Pages/cains_jawbone_page_43.md). Treat this as a strong merge candidate (`N24` → `N01`) unless a contradiction emerges. Phase 6 stitch candidate: page-body `I cannot` appears only on Pages/cains_jawbone_page_100.md and Pages/cains_jawbone_page_63.md (`N14`), and both pages treat Henry as physically handled (cap on/off ↔ “getting out of hand” / “drops awa”); keep as low-weight unless reinforced by a second independent anchor.
