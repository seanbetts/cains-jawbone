...
- **Join (confidence: `MAYBE`):** Pages/cains_jawbone_page_46.md → Pages/cains_jawbone_page_100.md
  ...
  - **Phase 6 test (2025-12-30):** searched for a second independent anchor tying Pages/cains_jawbone_page_79.md to Pages/cains_jawbone_page_100.md beyond the unique Hamlet phrase “as flush as May”; found no shared prop/participant/place marker (Bob Martin/Lagopus/Sandy are unique to Pages/cains_jawbone_page_79.md; Woolworth’s/Kursal are unique to Pages/cains_jawbone_page_100.md). Since Pages/cains_jawbone_page_79.md is strongly dog‑POV and Pages/cains_jawbone_page_100.md is not, treat this as a low-weight cross-quote echo only, not adjacency evidence.
  - **Phase 6 test (2025-12-30):** searched for a second independent anchor tying Pages/cains_jawbone_page_4.md to Pages/cains_jawbone_page_100.md beyond the unique “buttonhole” word; found no supporting shared prop/quote/place marker (the “buttonhole” echo remains the only overlap), so keep this as a weak stitch hypothesis only.
