...
### Proposed order (all 100 pages; v2.24)
...
### Phase 6 boundary tests for v2.24 (block boundaries)

- **Phase 6 scan (2026-01-04):** recomputed df==2 token/ngram overlaps for v2.24 *block-boundary* adjacencies (page-body only; Notes ignored). v2.24 removes the prior zero-anchor boundaries `Pages/cains_jawbone_page_20.md → Pages/cains_jawbone_page_4.md`, `Pages/cains_jawbone_page_11.md → Pages/cains_jawbone_page_28.md`, and `Pages/cains_jawbone_page_85.md → Pages/cains_jawbone_page_97.md` by relocating `Block I2` + `Block J` to sit immediately after Pages/cains_jawbone_page_20.md (new anchored boundaries `Pages/cains_jawbone_page_20.md → Pages/cains_jawbone_page_28.md` via df==2 token `stone`, and `Pages/cains_jawbone_page_85.md → Pages/cains_jawbone_page_4.md` via df==2 bigram `old thing`). The df==2 scan now flags the following block-boundary adjacencies with **zero** shared df==2 token anchors and **zero** shared df==2 n‑gram anchors (n=2–6): `Pages/cains_jawbone_page_25.md → Pages/cains_jawbone_page_33.md`, `Pages/cains_jawbone_page_53.md → Pages/cains_jawbone_page_81.md`, `Pages/cains_jawbone_page_5.md → Pages/cains_jawbone_page_49.md`, `Pages/cains_jawbone_page_31.md → Pages/cains_jawbone_page_7.md`, `Pages/cains_jawbone_page_11.md → Pages/cains_jawbone_page_97.md`, `Pages/cains_jawbone_page_93.md → Pages/cains_jawbone_page_56.md`, `Pages/cains_jawbone_page_71.md → Pages/cains_jawbone_page_66.md`, and `Pages/cains_jawbone_page_46.md → Pages/cains_jawbone_page_68.md`.

#### Phase 6 boundary ledger (v2.24; “zero-anchor” block boundaries)
...
- `Pages/cains_jawbone_page_53.md → Pages/cains_jawbone_page_81.md`: re-read says hard scene break (Trinder interview ↔ window-throw). Focused overlap scan (tokens df≤8; n‑grams df≤3) finds only the generic interjection `oh` (df=5) and **zero** shared low-df n‑gram anchors. **Status:** placeholder. **Next:** pursue Trinder/poison adjacency leads (`p53` ↔ `p59`/`p80`) but require a second non-lexical anchor before moving `N12`.
- `Pages/cains_jawbone_page_5.md → Pages/cains_jawbone_page_49.md`: re-read says no continuity beyond shared Henry-register. **Status:** placeholder. **Next:** treat as a Henry-cluster re-stitch problem; prioritise finding a better predecessor for Page 49 that preserves the `p49 → p13 → p31` internal constraints.
