...
- **Cluster:** Dog POV strand (confidence: `CERTAIN`)
  ...
  - **Phase 4 internal ordering hypotheses (Dog POV):**
    - **Sequence A — date-anchored spine (Aug 12→18)** (confidence: `LIKELY`)
      ...
      - **Next falsification check:** confirm whether Pages/cains_jawbone_page_88.md’s “Tom and Flora” are the same Flora as Pages/cains_jawbone_page_22.md/Pages/cains_jawbone_page_79.md (and thus could bridge Sequence A↔B) or a different pair of names.
