...
- **Cluster:** `N21` Dazed infatuation + bar/tea imagery voice (confidence: `LIKELY`)
  ...
  - **Placement note (Phase 4):** Pages/cains_jawbone_page_47.md is core `N21` voice evidence but currently **unplaced** relative to the `Pages/cains_jawbone_page_92.md → Pages/cains_jawbone_page_42.md` lock (no second continuity marker beyond the general infatuation/drink register).
  ...
  - **Phase 4 check (2026-01-05):** page-body word n‑gram scan (n=3–8) found **zero** shared n‑grams between Pages/cains_jawbone_page_47.md and Pages/cains_jawbone_page_92.md/Pages/cains_jawbone_page_42.md → keep Pages/cains_jawbone_page_47.md unplaced relative to the quote-continuation lock.
