...
- `Pages/cains_jawbone_page_53.md → Pages/cains_jawbone_page_81.md`: re-read says hard scene break (Trinder interview ↔ window-throw). **Status:** placeholder. **Next:** pursue Trinder/poison adjacency leads (`p53` ↔ `p59`/`p80`) but require a second non-lexical anchor before moving `N12`.
