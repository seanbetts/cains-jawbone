...
- `Pages/cains_jawbone_page_11.md → Pages/cains_jawbone_page_28.md`: re-read says no continuity (dog-register ↔ Pluckley/church-window “forging” scene). **Status:** placeholder. **Next:** identify a dog-register successor for Page 11 (or rehome Page 11) rather than moving Page 28 off its `p28 → p15` lock.
