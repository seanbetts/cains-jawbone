...
- **Join (confidence: `MAYBE`):** Pages/cains_jawbone_page_70.md → Pages/cains_jawbone_page_14.md
  ...
  - **Phase 6 test (2025-12-30):** corpus scan found no second anchor to support adjacency: Pages/cains_jawbone_page_70.md’s distinctive anchors (“franked”, Eros/Queen’s Hall, Orpen 1912, cabbage butterflies, Efate/Munich/Ming wordplay) appear only on p70, and Pages/cains_jawbone_page_14.md’s distinctive anchors (“ears… becoming attuned”, “dejected flesh”, Janetta Sheringham, buttered rolls/cricket-as-war-horse) appear only on p14. Pages/cains_jawbone_page_68.md / Pages/cains_jawbone_page_69.md contain no Eros/Queen’s Hall or franked-letter mechanics, so they do not currently bridge this join.
  - **Outcome:** `UNCLEAR` (keep as placeholder; treat as a likely re-stitch point once the `N09` strands are unified or ruled out).
