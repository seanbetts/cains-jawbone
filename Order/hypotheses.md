...
- **Cluster:** Dog POV strand (confidence: `CERTAIN`)
  ...
  - **Phase 4 internal ordering hypotheses (Dog POV):**
    - **Sequence A — date-anchored spine (Aug 12→18)** (confidence: `LIKELY`)
      ...
      - **Next falsification check:** look for any explicit tie between `P100` Tom/`P101` Flora and the dog‑mate Flora thread (e.g., direct address, shared setting detail, or a “Tom” reference that cannot be read as De Quincey or tomcat).
