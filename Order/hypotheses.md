...
- **Join (confidence: `MAYBE`):** Pages/cains_jawbone_page_46.md → Pages/cains_jawbone_page_100.md
  ...
  - **Phase 6 test (2025-12-31):** page-body n‑gram scan: the only 4‑gram shared uniquely with Pages/cains_jawbone_page_100.md is `why should i think` on Pages/cains_jawbone_page_17.md; all other overlaps found at 3‑gram level (e.g., `if i could` with Pages/cains_jawbone_page_41.md; `of course and` with Pages/cains_jawbone_page_16.md) are too generic to treat as adjacency evidence. Note: `of course and` is corpus-unique at 3‑gram level and co-occurs with a corpus-unique `henry he` bigram (only Pages/cains_jawbone_page_16.md + Pages/cains_jawbone_page_100.md), so keep Pages/cains_jawbone_page_16.md on the candidate bridge list — but do not promote without a second concrete anchor (shared prop/place/participant beyond `Henry`).
