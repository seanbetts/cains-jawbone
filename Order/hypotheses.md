...
- **Cluster:** `N16` St. Bruno / smell-memory + incinerator-evidence voice (confidence: `LIKELY`)
  ...
  - **Next falsification check:** keep Pages/cains_jawbone_page_55.md as edge-overlap unless a second distinctive `N16` anchor appears (e.g., St. Bruno/Hodge/incinerator-evidence cues, Typhoon-lock overlap, or a second date/holiday anchor in the same voice); for Pages/cains_jawbone_page_26.md ↔ Pages/cains_jawbone_page_45.md, try to find an additional shared prop/place/time anchor (beyond the “girl absent” echo) to confirm adjacency and direction; for Pages/cains_jawbone_page_44.md, look for any page that reuses the “incinerator / marriage certificate / second wife’s brother” evidence bundle to lock its placement relative to the Typhoon/witness scene.
