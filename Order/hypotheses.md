...
### Proposed order (all 100 pages; v2.4)
...
### Phase 6 boundary tests for v2.4 (block boundaries)
...
- **Join (confidence: `MAYBE`):** Pages/cains_jawbone_page_87.md → Pages/cains_jawbone_page_33.md
  - **Why:** current v2.4 block boundary placeholder (both contain letters + death language, but nothing concrete).
