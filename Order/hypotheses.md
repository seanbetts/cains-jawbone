...
- **Cluster:** Dog POV strand (confidence: `CERTAIN`)
  ...
  - **Phase 4 internal ordering hypotheses (Dog POV):**
    - **Sequence A — date-anchored spine (Aug 12→18)** (confidence: `LIKELY`)
      ...
      - **Resolved check:** bow continuity is strong: “jossers” appears only on Pages/cains_jawbone_page_99.md (ends unequal; he can’t find the “jossers” to fix it) and Pages/cains_jawbone_page_8.md (“Later she was wearing the same bow… and that time he found them and trimmed the left end”), supporting Pages/cains_jawbone_page_99.md → Pages/cains_jawbone_page_8.md.
