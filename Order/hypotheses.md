...
- `Pages/cains_jawbone_page_31.md → Pages/cains_jawbone_page_7.md`: re-read says no continuity; phrase echo suggests `p31 → p21` but lacks a second independent anchor. **Status:** placeholder. **Next:** either (a) find a second anchor for `p31 → p21` that survives re-read, or (b) find a different successor for Page 31 that keeps `p13 → p31` intact.
...
- **Join (confidence: `MAYBE`):** Pages/cains_jawbone_page_31.md → Pages/cains_jawbone_page_7.md
  ...
  - **Phase 6 test (2026-01-03):** additional replacement lead: Pages/cains_jawbone_page_31.md ↔ Pages/cains_jawbone_page_21.md share the phrase-level bundle `to reckon with henry` (4‑gram appears only on those two page bodies), and both depict the narrator confronting Henry at a fresh victim/body scene (“stooping/bending over the body” + blood). Treat `Pages/cains_jawbone_page_31.md → Pages/cains_jawbone_page_21.md` as a plausible successor candidate to replace this boundary once a second concrete continuity marker (shared place/prop/time) is found.
