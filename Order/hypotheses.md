...
- **Join (confidence: `MAYBE`):** Pages/cains_jawbone_page_34.md → Pages/cains_jawbone_page_96.md
  ...
  - **Outcome:** `UNCLEAR` (retain as placeholder; keep the Pages/cains_jawbone_page_29.md ↔ Pages/cains_jawbone_page_96.md phrase-echo as an active alternative hypothesis to test).
...
- **Join (confidence: `MAYBE`):** Pages/cains_jawbone_page_46.md → Pages/cains_jawbone_page_100.md
  ...
  - **Phase 6 test (2025-12-30):** searched for a second independent anchor tying Pages/cains_jawbone_page_1.md to Pages/cains_jawbone_page_100.md beyond the shared dead-man phrasing (“dead old man” ↔ “old dead”); found no shared prop/quote/place marker and the voices diverge sharply (pen-at-sea diary register vs Scotland Yard collapse). Treat as a possible shared-employer thread, but not adjacency evidence.
