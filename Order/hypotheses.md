...
- **Join (confidence: `MAYBE`):** Pages/cains_jawbone_page_83.md → Pages/cains_jawbone_page_92.md
  - **Why:** the page-body word `dew` appears only on these two pages (p83 rose-dew; p92 Browning “dew”), and both pages place `Henry` in-scene amid heavy allusion density, making this a plausible low-weight bridge between `N06` and `N21`.
  ...
  - **Next falsification check:** search for a second independent anchor beyond `dew` (venue/food/time-of-night; or a shared quoted source continuation).
  ...
  - **Outcome:** `UNCLEAR` (treat as a placeholder-bridge candidate only).
