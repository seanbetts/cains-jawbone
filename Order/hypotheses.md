...
- **Join (confidence: `MAYBE`):** Pages/cains_jawbone_page_46.md → Pages/cains_jawbone_page_100.md
  ...
  - **Bridge candidates (direction unknown):**
    ...
    - Pages/cains_jawbone_page_100.md ↔ Pages/cains_jawbone_page_84.md (shared “why the dead wanted this” setup: “why the deceased wished us to know each other” ↔ “why the old dead so wanted this”; both also hinge on wanting to speak to “her”), suggesting a possible late-coda stitch within the tail.
  ...
  - **Phase 6 test (2025-12-30):** searched for a second independent anchor tying Pages/cains_jawbone_page_38.md to Pages/cains_jawbone_page_100.md beyond the Southend pointer (Southend ↔ Kursal/Kursaal); found no additional shared prop/quote/participant marker, so treat this as a place-only bridge candidate pending further evidence.
