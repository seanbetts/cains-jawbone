...
- `Pages/cains_jawbone_page_25.md → Pages/cains_jawbone_page_33.md`: re-read says hard scene break (Didling/time-factor ↔ debts/cigarette-box). **Status:** placeholder. **Next:** find a successor for Page 25 that is *not* Page 33; treat `p25 ↔ p20` (`N34`) as the highest-value re-stitch direction if it can be reconciled without breaking the Page 18/20 `blank` lock.
