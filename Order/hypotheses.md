...
- **Cluster:** Dog POV strand (confidence: `CERTAIN`)
  ...
  - **Phase 4 internal ordering hypotheses (Dog POV):**
    - **Sequence A — date-anchored spine (Aug 12→18)** (confidence: `LIKELY`)
      - **Pages (ordered):** Pages/cains_jawbone_page_48.md (MAYBE: Nahum Tate/BCP “to-day” = Aug 12) → Pages/cains_jawbone_page_88.md (St Wigbert’s day = Aug 13) → Pages/cains_jawbone_page_39.md (George Combe “last day” = Aug 14) → Pages/cains_jawbone_page_10.md (Hyacinth’s day = Aug 16; “went back two days… bet”) → Pages/cains_jawbone_page_99.md (“closing day in Potsdam” = Aug 17) → Pages/cains_jawbone_page_8.md (Guido Reni + Kilmarnock/Balmerino “to-day” = Aug 18) → Pages/cains_jawbone_page_19.md (“Human Comedy”/Balzac “to-day” = Aug 18).
      - **Why:**
        - Explicit calendar/saint-day anchors step forward across 88/39/10/99/8/19, with Pages/cains_jawbone_page_48.md as a possible Aug 12 lead-in via the Tate/Book-of-Common-Prayer clue (drop Pages/cains_jawbone_page_48.md if that anchor fails).
  ...
  - **Resolved check:** POV audit found no unequivocal human-only physical situations in the core Dog POV pages; Pages/cains_jawbone_page_8.md remains the weakest fit because “powerful glass” may be a literal magnifying glass (human-only), so treat it as a `MAYBE` extension within `N02`.
  - **Resolved check:** date-spine audit confirms the Aug 13→18 anchors as independently corroborated (St. Wigbert Aug 13; Combe “last day” Aug 14 (LIKELY); St. Hyacinth Aug 16; Frederick II “closing day in Potsdam” Aug 17; Guido Reni + Kilmarnock/Balmerino Aug 18; Balzac Aug 18). Pages/cains_jawbone_page_48.md remains a candidate Aug 12 lead-in (drop if later contradicted).
  - **Next falsification check:** re-interpret Pages/cains_jawbone_page_8.md’s “powerful glass” (literal magnifying glass vs metaphor) to decide whether to keep it inside `N02` or treat it purely as an adjacent domestic-scene overlap retained only for the bow/Mr. Hall continuity.
