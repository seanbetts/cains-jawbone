...
- **Cluster:** `N02` Dog POV (confidence: `CERTAIN`)
  ...
  - **Phase 4 internal ordering hypotheses (N02):**
    - **Spine — mid‑August daybook run** (confidence: `LIKELY`)
      ...
      - **Why:**
        - Pages/cains_jawbone_page_48.md ↔ Pages/cains_jawbone_page_88.md: “Tate” (sugar stash) appears only on these pages, and both share the dog-as-observer domestic register; Pages/cains_jawbone_page_48.md’s “another Tate”/Book-of-Common-Prayer “worm” clue makes a LIKELY Aug 12 lead-in (Nahum Tate died 12 Aug 1715; DNB).
