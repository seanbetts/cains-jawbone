...
- **Cluster:** Dog POV strand (confidence: `CERTAIN`)
  ...
  - **Phase 4 internal ordering hypotheses (Dog POV):**
    - **Sequence A — date-anchored spine (Aug 12→18)** (confidence: `LIKELY`)
      ...
      - **Next falsification check:** reconcile “Jasmine” across the Dog POV set (Pages/cains_jawbone_page_22.md cat; Pages/cains_jawbone_page_88.md “Tom and Flora’s Jasmine”; Pages/cains_jawbone_page_99.md “as Jasmine… called them”; Pages/cains_jawbone_page_46.md “matter of Jasmine”) to determine whether these are the same referent and can be used as a sequencing bridge.
