...
- **Entities:**
  - CERTAIN: Hélène.
  - MAYBE: “half Pole, half Frenchman” (unnamed; described as a drunken waster).
  - MAYBE: Henry (seen bending over a corpse; narrator unsure the name is correct).
...
- **Clustering hypotheses:**
  ...
  - LIKELY: connects to Pages/cains_jawbone_page_26.md via the “The girl…” echo (“The girl was no longer there” ↔ “The girl had left Henry…”); treat as a thread lock `Pages/cains_jawbone_page_26.md ↔ Pages/cains_jawbone_page_45.md` (direction TBD in Phase 4; see `Order/hypotheses.md` constraints inventory).
