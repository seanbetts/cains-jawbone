...
- **Ordering hypotheses:**
  ...
  - LIKELY: follows Pages/cains_jawbone_page_44.md (shared Henry/evidence + flats-surveillance register).
  - MAYBE: follows Pages/cains_jawbone_page_7.md (*Typhoon* reread → *Typhoon* quote hinge).
