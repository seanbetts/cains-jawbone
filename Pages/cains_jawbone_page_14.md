...
- **Clustering hypotheses:**
  - CERTAIN: links strongly with Pages/cains_jawbone_page_12.md (overheard “leave everything… May” + spilled wine/flesh cleanup beat ↔ “documents/abstracted will” scene). Treat as a continuity constraint `Pages/cains_jawbone_page_12.md ↔ Pages/cains_jawbone_page_14.md` and resolve direction in Phase 4; see `Order/hypotheses.md` constraints inventory.
