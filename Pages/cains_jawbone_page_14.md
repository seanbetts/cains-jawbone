...
- **Ordering hypotheses:**
  - LIKELY: Pages/cains_jawbone_page_14.md → Pages/cains_jawbone_page_12.md (overheard “leave everything… May” → “abstracted will” document scene; spilled wine ↔ “bad head” hangover texture; see `Order/hypotheses.md` `N10` block).
