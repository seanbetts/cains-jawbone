...
- **Motifs/continuity hooks:**
  ...
  - Phase 3 micro-pass (2026-01-04): body-only df==2 token overlaps `purple` (Pages/cains_jawbone_page_98.md) and `smoke` (Pages/cains_jawbone_page_75.md); treat as low-weight overlap leads only.
