...
- **Clustering hypotheses:**
  ...
  - CERTAIN: cross-narrator quote continuation/substitution lock with Pages/cains_jawbone_page_23.md (Masefield “Captain Stratton’s Fancy” line on p23 followed by Yeats “Cathleen…” line here). Treat as a continuity constraint `Pages/cains_jawbone_page_23.md ↔ Pages/cains_jawbone_page_24.md`; see `Order/hypotheses.md` constraints inventory.
  - CERTAIN: links strongly with Pages/cains_jawbone_page_30.md (Page 30 ends with “Can she be guilty?” after a “try her out” soup-tasting test; this page opens “Next day…” with “my suspicions… had been well-founded.”). Treat as a continuity constraint `Pages/cains_jawbone_page_24.md ↔ Pages/cains_jawbone_page_30.md` and resolve direction in Phase 4; see `Order/hypotheses.md` constraints inventory.
