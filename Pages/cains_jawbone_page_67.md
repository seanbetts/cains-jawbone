...
- **Quotes & allusions:**
  - CERTAIN: “herb of grace” = rue (Ophelia, Shakespeare’s *Hamlet*, Act IV, Scene V; see `Indexes/research_queue.md`).
  - MAYBE: “Helen and crooning? Poe and Prohibition? … Menkin?” (dense allusive menu of celebration options; partially resolved; see `Indexes/research_queue.md`).
...
- **Research needed:**
  - Stalled: pin down the “Helen/Poe/Prohibition/… Menkin” references beyond the partial Hamlet/Mencken identifications (see `Indexes/research_queue.md`).
