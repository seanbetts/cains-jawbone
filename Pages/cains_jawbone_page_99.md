...
- **Motifs/continuity hooks:**
  ...
  - Phase 3 micro-pass (2026-01-05): body-only df==2 token overlaps: `sun` (Pages/cains_jawbone_page_43.md), `large` (Pages/cains_jawbone_page_51.md), `foot` (Pages/cains_jawbone_page_68.md), `dry` (Pages/cains_jawbone_page_69.md), `chest` (Pages/cains_jawbone_page_73.md), `especially` (Pages/cains_jawbone_page_84.md), `brilliant` (Pages/cains_jawbone_page_90.md). Treat as overlap-only unless reinforced by a second independent anchor.
- **Places:**
