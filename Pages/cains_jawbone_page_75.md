...
- **Clustering hypotheses:**
  ...
  - MAYBE: cross-narrator overlap candidate with Pages/cains_jawbone_page_12.md via the unique “searchlights” eye-metaphor over documents/writing; treat as a cross-narrator candidate `Pages/cains_jawbone_page_12.md ↔ Pages/cains_jawbone_page_75.md` (see `Order/hypotheses.md`).
