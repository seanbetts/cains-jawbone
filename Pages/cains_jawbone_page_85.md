...
- **Entities:**
  - CERTAIN: Henry (driven home by narrator).
  - CERTAIN: “she” (unnamed; asleep at the table; described as “a nice old thing”).
...
- **Clustering hypotheses:**
  ...
  - MAYBE: body-only df==2 overlaps: `it occurred to me` with Pages/cains_jawbone_page_25.md; token `twin` with Pages/cains_jawbone_page_47.md; token `jibe` with Pages/cains_jawbone_page_90.md. Treat as overlap-only unless a second, non-lexical continuity anchor aligns.
