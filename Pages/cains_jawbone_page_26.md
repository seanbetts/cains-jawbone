...
- **Clustering hypotheses:**
  ...
  - MAYBE: body-only df==2 token overlap with Pages/cains_jawbone_page_37.md: `sent`. Treat as a low-weight cross-voice bridge only unless reinforced by a second independent anchor.
