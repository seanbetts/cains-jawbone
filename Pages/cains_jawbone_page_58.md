...
- **Clustering hypotheses:**
  ...
  - LIKELY: links to Pages/cains_jawbone_page_5.md via the page-body unique “went on … Browning” complaint (“He went on about Browning.” ↔ “He went on talking about Browning.”); treat as a continuity constraint `Pages/cains_jawbone_page_5.md ↔ Pages/cains_jawbone_page_58.md` (see `Order/hypotheses.md`). If the murder-count tally is consistent (“fourth” ↔ “intended fifth”), tentative direction is `Pages/cains_jawbone_page_58.md → Pages/cains_jawbone_page_5.md` (confidence: `MAYBE`).
