...
- **Clustering hypotheses:**
  ...
  - MAYBE: body-only df==2 token overlap with Pages/cains_jawbone_page_53.md: `purpose` (p4 “for another purpose” ↔ p53 “for my purpose”). Treat as a low-weight cross-voice bridge only unless reinforced.
