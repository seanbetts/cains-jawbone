...
- **Motifs/continuity hooks:**
  ...
  - Phase 3 micro-pass (2026-01-04): body-only df==2 token overlaps: `ordered` (Pages/cains_jawbone_page_60.md), `ame` (Pages/cains_jawbone_page_73.md), `son` (Pages/cains_jawbone_page_88.md). Treat as overlap/bridge leads only unless reinforced by a second independent anchor.
