...
- **Clustering hypotheses:**
  ...
  - MAYBE: if a draft joins Pages/cains_jawbone_page_27.md ↔ Pages/cains_jawbone_page_25.md on the single df==2 token `woke`, treat it as a likely cross-narrator boundary (`N03` ≠ `N34`) unless a second independent continuity anchor appears.
