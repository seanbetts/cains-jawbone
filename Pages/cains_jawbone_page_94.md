...
- **Clustering hypotheses:**
  ...
  - CERTAIN: strong continuity hook with Pages/cains_jawbone_page_85.md via the narrator-name tell (window-sign “my own name” ↔ Kipling/KING wordplay) plus Henry in-scene; LIKELY within-voice order: `Pages/cains_jawbone_page_94.md → Pages/cains_jawbone_page_85.md` (“Henry was waiting for me” → “I was true to time” / “I drove Henry home”); see `Order/hypotheses.md` (`N08`).
